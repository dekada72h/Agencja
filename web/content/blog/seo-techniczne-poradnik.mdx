...
faq:
  ...
  -
    ...
    a: "Trzy obligatoryjne dla wiekszości witryn: Organization (każda firma) lub LocalBusiness (lokalne firmy), BreadcrumbList (na każdej podstronie z hierarchia URL), WebSite z SearchAction (dla glownej domeny). Dla blogow/news: Article + Author + Publisher. Dla e-commerce: Product + Offer + Review/AggregateRating. Dla branży uslugowej: Service + FAQPage. W 2026 nowe rozszerzenia: VideoObject (z timestamps), HowTo (dla tutorialow), Course (dla edukacji), JobPosting (dla rekrutacji)."
  -
