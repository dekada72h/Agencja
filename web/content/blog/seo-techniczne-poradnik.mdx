...
faq:
  -
    q: "Czym rozni się techniczne SEO od on-page SEO?"
    a: "Techniczne SEO koncentruje się na warstwie infrastrukturalnej strony: szybkość ładowania, Core Web Vitals, crawlability, indexability, schema markup, mobile-first, security headers, rendering. On-page SEO to optymalizacja widocznej treści: tytuly, naglowki, meta tagi, slowa kluczowe, internal linking, struktura treści. Oba sa potrzebne i się uzupelniaja - techniczne SEO bez on-page nie pomoże (Google nie wie co rankowac), on-page bez technicznego też nie zadziala (jeśli strona nie jest indeksowalna)."
  -
    q: "Ile kosztuje audyt techniczny SEO?"
    a: "Sredniej wielkości audyt techniczny SEO (do 500 podstron) to 2 500-8 000 zl. Maly audyt (do 100 podstron, podstawowe metryki) zaczyna się od 1 500-3 000 zl. Glebszy audyt z analiza logow serwera, JS rendering, full schema review i konkretnymi prioretyzowanymi rekomendacjami to 8 000-20 000 zl. Audyt enterprise (10 000+ podstron, międzynarodowe SEO, audyt platform headless) potrafi siegac 30 000-80 000 zl. Wartość: dobry audyt zwraca się wielokrotnie przez wzrost ruchu organicznego."
  -
    q: "Jak długo trwa wdrozenie poprawek po audycie technicznym SEO?"
...
related:
  ...
  -
    ...
    title: "HTML vs WordPress - Co Wybrać dla Strony Firmowej"
    category: "Strony WWW"
    excerpt: "Porownanie HTML i WordPress pod katem szybkości, bezpieczenstwa, kosztów i SEO dla firm usługowych."
  -
    href: "/blog/ile-kosztuje-strona-internetowa"
    title: "Ile Kosztuje Strona Internetowa w 2026 - Pelny Cennik"
    category: "Strony WWW"
    excerpt: "Realne ceny stron WWW 2026, ukryte koszty utrzymania i jak ocenić, czy oferta agencji jest uczciwa."
---
...
<StatHighlight>
  ...
  <Stat number="53%">mobile users opuszcza strony ładujące się dluzej niz 3s</Stat>
...
Wartość technicznego SEO: jeden dobrze zrobiony audyt + wdrozenie może zwiekszyc ruch organiczny o 30-200%. Na przykład, dla srednich e-commerce'ow, którzy mieli LCP 5.2s i poprawili do 2.1s, sredni wzrost konwersji to 18%, a ruchu organicznego 47% w ciągu 3 miesiecy po wdrozeniu.
...
| Branża | LCP cel | INP cel | CLS cel | Sredni 2026 |
|---|---|---|---|---|
...
Optymalizacja crawl budget: (1) Blokuj nisko wartościowe URL (filtry, sortowania, search results) w robots.txt, (2) Uzyj `noindex` meta tag dla URL które nie powinny być w indexie ale mogą być crawled, (3) Zoptymalizuj internal linking - kluczowe strony powinny być według 2-3 kliknięć od homepage, (4) Usun duplicate content (canonical tags), (5) Popraw site speed - szybsze ładowanie = wiecej crawl per czas.
...
Zaawansowana technika: zagniezdzone schemas - jeden schema w drugim. Przykład: Article + Author + Organization + Publisher + Image + BreadcrumbList. Im wiecej zagnezdzonych schemas, tym większa szansa na rich results.

Praktyczny przykład - artykul blogowy w 2026 ma idealnie:
...
3. **Sitemap hreflang** - dla dużych witryn:
```xml
<url>
...
Google Search Console -> Settings -> International Targeting. Możesz ustawic country target dla całej domeny lub subfolderow. Przykład: example.com/pl/ -> target Poland.
...
<Callout>
**Critical**: INP zastapilo FID jako oficjalny Core Web Vital w marcu 2024. Jeśli twoja strona ma INP >500ms, ranking spada nawet jeśli LCP/CLS sa OK. Najczestszy problem: third-party scripts (analytics, chat widgets, ads) blokujące main thread. Audit i optimizuj defer/async timing wszystkich scriptow zewnętrznych.
</Callout>

<Callout>
**Quick win**: Dodanie schema markup typu FAQPage może podwoic CTR z SERP, a wdrozenie zajmuje 1-2h. JSON-LD w `<head>` strony z FAQ sekcja, walidacja w Rich Results Test, deploy. Wzrost CTR widoczny w GSC w ciągu 2-4 tygodni od indeksacji nowego schema.
</Callout>
...
Sredni audyt techniczny SEO + wdrozenie poprawek to 2-4 miesiace pracy, ale efekty - 30-200% wzrost ruchu organicznego - utrzymuja się przez lata. To jest inwestycja, która zwraca się wielokrotnie. Zwlaszcza dla [stron firmowych](/blog/strona-internetowa-dla-firmy) i [e-commerce](/blog/ile-kosztuje-strona-internetowa) konkurujących w nasyconych branzach.
