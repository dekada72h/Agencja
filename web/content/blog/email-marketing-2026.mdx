...
- **Easy unsubscribe** 1 click + naglowek `List-Unsubscribe: <one-click>` — wymog Gmail/Outlook od 2024
- **SPF, DKIM, DMARC** na domenie wysylkowej — bez tego maile B2B leca do spamu
- **Polityka transferu danych** w polityce prywatnosci jesli narzedzie jest hostowane w USA
- **Data retention policy** — jak dlugo trzymasz dane po wypisie + procedura "right to be forgotten"
</KeyPoints>
