// Inline SVG icons matching the original site's vocabulary.
// Kept hand-rolled (rather than lucide-react) so stroke widths and viewBoxes
// match the legacy markup pixel-for-pixel.
